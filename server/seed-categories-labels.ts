import { db } from './db';
import { categories, labels } from '@shared/schema';
import { sql } from 'drizzle-orm';

async function seedCategoriesAndLabels() {
  try {
    console.log('Starting to seed categories and labels...');
...
export { seedCategoriesAndLabels };