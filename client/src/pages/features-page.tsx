        ...
        <section className="pt-28 pb-16 lg:pt-40 lg:pb-24 bg-gradient-to-r from-[#5e2eff] to-[#a66fff] text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              {/* Feature Icons */}
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 mb-6 max-w-7xl mx-auto">
                {/* Top Row */}
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  ...
                  <span className="text-lg font-medium">Header Builder</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                  ...
                  <span className="text-lg font-medium">Footer Builder</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                  ...
                  <span className="text-lg font-medium">Section Builder</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-lg font-medium">Full Page Layouts</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-lg font-medium">Blog Layouts</span>
                </div>
              </div>
              
              {/* Second Row */}
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 mb-16 max-w-7xl mx-auto">
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                  ...
                  <span className="text-lg font-medium">Colors & Typography</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="text-lg font-medium">WooCommerce</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  ...
                  <span className="text-lg font-medium">Social Accounts</span>
                </div>
                <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl px-6 py-8 hover:bg-white/20 transition-all min-w-[200px]">
                  <div className="h-16 w-16 mb-4 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-lg font-medium">AI Assistance</span>
                </div>
              </div>
            </div>
          </div>
