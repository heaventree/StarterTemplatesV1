              ...
              <div className="w-full max-w-6xl mx-auto px-4 mb-12">
                ...
                <div className="grid grid-cols-5 gap-8 mb-8">
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Header Builder</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Footer Builder</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Section Builder</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Full Page Layouts</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Blog Layouts</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-5 gap-8">
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Colors & Typography</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">WooCommerce</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Integrations</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">Social Accounts</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md rounded-xl p-5 hover:bg-white/20 transition-all">
                    ...
                    <span className="text-white text-sm text-center">AI Assistance</span>
                  </div>
                </div>
              </div>
            </div>
